...
if __name__ == "__main__":
    ...
    # ---------------------------------------------------------------------#
    # yaml_file_path = 'D:/BIRD/year4/FinalYearProject/AgroGuard/AgroGuard_Pytorch/dataset/data.yaml'
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = 'D:\BIRD\year4\FinalYearProject\AgroGuard\AgroGuard_Pytorch\models\yolov8n.pt'  # 加载的预训练权重一定要和backbone对应
    # ------------------------------------------------------#
    ...
    val_annotation_path = 'D:\\BIRD\\year4\\FinalYearProject\\AgroGuard\\AgroGuard_Pytorch\\dataset\\ImageSets\\Main\\2007_val.txt'  # 用于测试而非验证
